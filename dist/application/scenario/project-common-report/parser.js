...
import { File, ProjectCommonReport } from "../../../domain/entity/index.js";
import { CreateUserId, FileName, FilePath, ProjectId, ProjectReportId, ReportText, Title, UploadUserId, YearMonthDay } from "../../../domain/value/index.js";
export class ProjectCommonReportParser {
    ...
    convertProjectReportToReference(entity) {
        const { id, files, projectId, reportDate, createUserId, title, reportText } = entity;
        return {
            id: id.value,
