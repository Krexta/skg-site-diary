...
import { File, ProjectCommonReport, UpdateProjectCommonReport } from "./index.js";
...
describe('ProjectCommonReport', ()=>{
    it('should return ProjectCommonReport when input is valid', ()=>{
        fc.assert(fc.property(makeCreateProperty(), (args)=>{
            const entity = new ProjectCommonReport(args);
    ...
    describe('update', ()=>{
        it('should return UpdateProjectCommonReport when input is valid', ()=>{
            fc.assert(fc.property(fc.record({
                createArgs: makeCreateProperty(),
                updateArgs: makeUpdateProperty()
            }), ({ createArgs, updateArgs })=>{
                const entity = new ProjectCommonReport(createArgs);
                expect(entity).toBeInstanceOf(ProjectCommonReport);
                const update = entity.update(updateArgs);
                expect(update).toBeInstanceOf(UpdateProjectCommonReport);
...
//# sourceMappingURL=ProjectCommonReport.spec.js.map